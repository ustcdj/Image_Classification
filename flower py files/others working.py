...
create command_checkpoint.pth file

python train.py --gpu -p='flowers'
...
# Loading Dataset
image_trainloader, image_testloader, image_valloader, image_trainset  = utility_functions.loading_data(data_dir)
...
# Training Model
utility_functions.my_DLM(model, image_trainloader, image_valloader, epochs, print_every, criterion, optimizer, device)

# Testing Model
utility_functions.testing(model, image_testloader)
